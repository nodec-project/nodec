...
template<typename T>
T from_little_endian(const T& src) {
    T dest{};
    internal::little_endian_conv<T>::from(src, dest);
    return dest;
}

template<typename T>
T to_little_endian(const T& src) {
    T dest{};
    internal::little_endian_conv<T>::to(src, dest);
    return dest;
}
template<typename T>
T from_big_endian(const T& src) {
    T dest{};
    internal::big_endian_conv<T>::from(src, dest);
    return dest;
}

template<typename T>
T to_big_endian(const T& src) {
    T dest{};
    internal::big_endian_conv<T>::to(src, dest);
    return dest;
}
